...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($_POST['title']) || empty($_POST['contentBlog']) || empty($_POST['author'])) {
        ...
        //tiny api handling sanitization of blogContent field
        ...
        if (empty($errorMessage)) {
            ...
            $statement->bindValue(':contentBlog', $_POST['contentBlog']);//storing $post Content to store formatted text edit by Tiny API
