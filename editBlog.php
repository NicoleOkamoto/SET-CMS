...
//retrieve blog post to be edited
...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/6du07rligevytivn166k977b47vxvwi6jix3bpe6vaycy8t7/tinymce/7/tinymce.min.js"
...
<body>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea id="mytextarea" name="contentBlog"
                placeholder="Type here..."><?= $post['contentBlog'] ?></textarea>
        </div>
        <div class="mb-3">
    ...
    <!-- Script Tiny Text editor API  -->
    <script src="https://cdn.tiny.cloud/1/6du07rligevytivn166k977b47vxvwi6jix3bpe6vaycy8t7/tinymce/5/tinymce.min.js"
        referrerpolicy="origin"></script>
    <script>
        tinymce.init({
            selector: '#mytextarea',
